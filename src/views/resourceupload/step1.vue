<template>
    <el-row class="ecrm-mode-content">
        <el-col class="ecrm-upload-sub">
            <el-button type="primary" @click="chooseFile">上传我的资源</el-button>
            <el-col class="ecrm-upload-tips">
                （支持单个文件、多个文件、以及文件夹的上传）
            </el-col>
        </el-col>
        <input type="file" id="inputfile" name="inputfile" hidden @change="chosenFile"></input>
        <el-col class="ecrm-upload-det">
